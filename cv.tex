...
abstractions. Maki is the tool associated with my 2024 ICSE paper,
\textit{Semantic Analysis of Macro Usage for Portability}.}
\vspace{2pt}
\resumeItem{Cpp2C}
...
\vspace{2pt}
\volunteeringItem
{OOPLSA 2024 Artifact Evaluation Commitee Member}
